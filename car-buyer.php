...
<head>
  ...
  <title>Car- Buyer - Just Join</title>
  <meta
...
<body>
  ...
  <div class="text-right mt-5">
    ...
    <div class="panel employee-panel-primary">
      <div class="panel-heading">Looking for buy a car? please fill the below application</div>
    </div>
    ...
    <div class="panel panel-danger">
      ...
      <div class="form-row">
        ...
        <label for="model">Car Model</label>
          <input type="text" class="form-control" id="model"
            placeholder="Ex: Tata, Maruthi, ..." value="">
        </div>
        <div class="form-group col-md-6">
      ...
      <div class="form-row">
       ...
       <!-- <div class="form-group col-md-6">
          <label for="yearOfPurchase">Manufacturing Year<span class="mandatory">*</span></label>
          <input type="date" class="form-control" id="yearOfPurchase" placeholder="DD/MM/YYYY"
           value="">
        </div>  -->
        <div class="form-group col-md-6">
        <label for="yearOfPurchase">Prefered manufacturing year</label>
          <select id="yearOfPurchase" class="form-control">
            <option value="null" selected>Select</option>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="minPrice"
              placeholder="Ex: 2,00,000" value="">
        </div>
        <div class="form-group col-md-6">
          <label for="maxPrice">Maximum Price</label>
          <input type="text" class="form-control" id="maxPrice"
              placeholder="Ex: 2,50,000" value="">
        </div>
      </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
  ...
  <script src="./assets/js/car-buyer.js"></script>
