...
<body>
  ...
  <div class="text-right mt-5">
    ...
    <div class="panel employer-panel-primary">
      <div class="panel-heading">Looking for sale your car? please fill the below application</div>
    </div>
    ...
    <div class="panel panel-danger">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="number" name="aadhar" class="form-control" id="aadhar" placeholder="Aadhar Number"
           >
        </div>     
        <div class="form-group col-md-6">
      ...
      <div class="form-group col-md-12">
        <div class="panel panel-danger">
            <div class="panel-heading">Please fill your car details below</div>      
        </div>
      </div>
    </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input name="yearOfPurchase" type="text" class="form-control" id="yearOfPurchase" placeholder="Manufacturing Year"
           value="">
        </div>  
      </div>
      <div class="form-row">
      ...
      <div class="form-group col-md-6">
        ...
        <!-- <div class="form-group col-md-6">
          ...
          <input name="dateOfSubmit" type="Date" class="form-control" id="dateOfSubmit" placeholder="DD/MM/YYYY">
        </div>  -->
  ...
  <script src="./assets/js/car-seller.js"></script>
