  ...
  <?php
    ...
    <div class="form-row">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
        <label for="fuelType">Fuel<span class="mandatory">*</span></label>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="date" class="form-control" id="yearOfPurchase" name="yearOfPurchase" placeholder="DD/MM/YYYY"
      ...
      <div class="form-row">        
        <div class="form-group col-md-6">
          ...
          <input type="Date" class="form-control" id="dateOfSubmit" name="dateOfSubmit" placeholder="DD/MM/YYYY" value="<?php echo $row['submit_date']?>">
        </div>        
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
      ...
      <div class="form-group col-md-4">
        <label for="employerStatus">Employee Joining Status</label>
          <select id="employerStatus" name="employerStatus" class="form-control <?php echo $row['employer_status'] == 'Active' ? 'green' : 'gray';?>">
