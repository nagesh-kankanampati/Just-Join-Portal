...
<body>
            ...
            <nav class="nav-menu d-none d-xl-block">
                    <ul>
                      <li class="drop-down scrolltoDrop"><a href="#">Staffing Solutions</a> 
                        <ul>
                        <li><a href="../ep/adep-dashboard.php" class="btn btn-block employee">Employee</a></li>
                        <li><a href="../er/ader-dashboard.php" class="btn btn-danger btn-block">Employer</a></li>
                        </ul>
                      </li>
                      ...
                      <li class="drop-down scrolltoDrop"><a href="#">Pre-Owned Cars</a> 
                        <ul>
                            ...
                            <li><a href="./adcs-dashboard.php" class="employer">Seller</a></li>
                          </ul>
                      </li>
                      <li class="pt-0 pl-0"> <a href="javascript:void(0)" class="employer-btn scrollto"><?php echo $_SESSION["username"]?></a></li>
                      <li class="pt-0 pl-0"><a href = "../../../snippets/logout.php" class="employee-btn scrollto">Logout</a></li>
    ...
    <div class="container pt-130">
        <div class="panel employer-panel-primary">
          <div class="panel-heading">Car Seller </div>      
        </div>
    </div>
<!-- requirement details end -->
<?php 
        $sql = "SELECT * FROM car_seller ORDER BY id DESC";
        $result = $conn->query($sql);
        $rowsCount = mysqli_num_rows($result);
        if ($result->num_rows > 0) {
            // Total Completed
            $sqlActive = "SELECT * FROM car_seller WHERE employee_status = 'Active'";
            ...
            // Total In Completed
            $sqlInActive = "SELECT * FROM car_seller WHERE employee_status = 'In Active'";
...
<a href="#" class="back-to-top"><i class="ri-arrow-up-line"></i></a>
 ...
 <!-- <script src="assets/vendor/waypoints/jquery.waypoints.min.js"></script>
  ...
  <script>     
        ...
        // edit 
        function edit(id){
            window.open('./cs-profile-edit.php?id='+id, '_self');
        }
        function del(delId){
