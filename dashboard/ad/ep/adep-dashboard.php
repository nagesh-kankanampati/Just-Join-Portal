...
<body>
    ...
    <div class="row block" id="hero">
            <div class="col-lg-12 p-0"><a href="../er/ader-dashboard.php" class="btn btn-block employer">Go to Employer</a></div>
        </div>
    </section> -->
    ...
    <?php       
        ...
        $sqlSchool = "SELECT * FROM employee  WHERE organization = 'School' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlCollege = "SELECT * FROM employee  WHERE organization = 'College' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlHospital = "SELECT * FROM employee WHERE organization = 'Hospital' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlSuperMarkets = "SELECT * FROM employee WHERE organization = 'Super Markets' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        if($resultSuperMarkets){
            ...
            // $dataSuperMarkets[0]['organization'];
        }
        ...
        $dataMallss = array();
        $dataMallssCat = array();
        $sqlMalls = "SELECT * FROM employee WHERE organization = 'Malls' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        // Total Completed
        $sqlActive = "SELECT * FROM employee WHERE employee_status = 'Active'";
        ...
        // Total In Completed
        $sqlInActive = "SELECT * FROM employee WHERE employee_status = 'In Active'";
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($dataSchools as $s){
                                                        if ($dataSchoolsCat == 'School' && $s == 'Active') {
                                                            $schoolInCompleted=mysqli_query($conn, "SELECT count(*) as schoolInCompleteTotal FROM employee WHERE organization = 'School' && employee_status = 'Active' GROUP BY organization");
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($dataColleges as $c){
                                                        if ($dataCollegesCat == 'College' && $c == 'Active') {
                                                            $collegeInCompleted=mysqli_query($conn, "SELECT count(*) as collegeInCompleteTotal FROM employee WHERE organization = 'College' && employee_status = 'Active' GROUP BY organization");
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($dataHospitals as $h){
                                                        if ($dataHospitalsCat == 'Hospital' && $h == 'Active') {
                                                            $hospitalInCompleted=mysqli_query($conn, "SELECT count(*) as hospitalInCompleteTotal FROM employee WHERE organization = 'Hospital' && employee_status = 'Active' GROUP BY organization");
                                                ...
                                                <?php
                                                    ...
                                                    foreach($dataSuperMarketss as $smm){
                                                        if ($dataSuperMarketssCat == 'Super Markets' && $smm == 'Active') {
                                                            $superMarketsInCompleted=mysqli_query($conn, "SELECT count(*) as superMarketsInCompleteTotal FROM employee WHERE organization = 'Super Markets' && employee_status = 'Active' GROUP BY organization");
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($dataMallss as $dm){
                                                        if ($dataMallssCat == 'Malls' && $dm == 'Active') {
                                                            $mallsInCompleted=mysqli_query($conn, "SELECT count(*) as mallsInCompleteTotal FROM employee WHERE organization = 'Malls' && employee_status = 'Active' GROUP BY organization");
        ...
        <div class="row block">
            <div class="col-lg-12" id="table_container">
                <table class="table table-bordered" id="table_main">
                        ...
                        <tbody id="tbody">
                        <!-- <td><a href="javascript:void(0)" class="btn btn-dark btn-block" onclick="return view('.$row["id"].');">View</a></td> -->
                        <?php 
