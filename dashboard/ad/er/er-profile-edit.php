  ...
  <?php
    ...
    <form id='employer-form' class="employer-form">
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          <label for="employerDesignation">Designation in your organization<span class="mandatory">*</span></label>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <label for="organizationType">Select organization type<span class="mandatory">*</span></label>
        ...
        <div class="form-group col-md-6">
          <label for="organisationName">Name of your organisation<span class="mandatory">*</span></label>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          <label for="employerEmail">Email<span class="mandatory">*</span></label>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          ...
          <select id="employeeExperience" class="form-control">
            <option value="null">Choose...</option>
            <option <?php echo $row['experience'] == '0' ? 'selected = "selected"' : '';?>>0</option>
            <option <?php echo $row['experience'] == '1' ? 'selected = "selected"' : '';?>>1</option>
            <option <?php echo $row['experience'] == '2' ? 'selected = "selected"' : '';?>>2</option>
            <option <?php echo $row['experience'] == '3' ? 'selected = "selected"' : '';?>>3</option>
            <option <?php echo $row['experience'] == '4' ? 'selected = "selected"' : '';?>>4</option>
            <option <?php echo $row['experience'] == '5' ? 'selected = "selected"' : '';?>>5</option>
          </select>
        </div>
        <div class="form-group col-md-2">
          <label for="employeeSalaryMin">Salary Min</label>
          <input class="form-control" type="number" id="employeeSalaryMin" placeholder="Ex: 10000" value="<?php echo $row['salary_min']?>">
        </div>
        <div class="form-group col-md-2">
          <label for="employeeSalaryMax">Salary Max</label>
          <input class="form-control" type="number" id="employeeSalaryMax" placeholder="Ex: 20000" value="<?php echo $row['salary_max']?>">
        </div>
        <div class="form-group col-md-4">
        <label for="employerStatus">Employee Joining Status</label>
          <select id="employerStatus" class="form-control <?php echo $row['employer_status'] == 'Active' ? 'green' : 'gray';?>">
            <option value="In Active" <?php echo $row['employer_status'] == 'In Active' ? 'selected = "selected"' : '';?>>In Active</option>
            <option value="Active" <?php echo $row['employer_status'] == 'Active' ? 'selected = "selected"' : '';?>>Active</option>
          </select>
        </div>
        <div class="form-group col-md-4">
          <label for="employeeReached">Contacted?<?php echo $row['reached']; ?></label>
    ...
    <a href="./ader-dashboard.php" class="btn btn-danger btn-lg">Cancel</a>
    </form>
  </div>
