...
<body>
              ...
              <nav class="nav-menu d-none d-xl-block">
                    <ul>
                      ...
                      <li class="drop-down scrolltoDrop"><a href="#">Realestate</a> 
                        <ul>
                            <li><a href="./adrb-dashboard.php" class="employee">Buyer</a></li>
    ...
    <?php       
        ...
        $sqlSchool = "SELECT * FROM real_estate_buyer  WHERE property_type = 'house' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlCollege = "SELECT * FROM real_estate_buyer  WHERE property_type = 'land' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlHospital = "SELECT * FROM real_estate_buyer WHERE property_type = 'agriculture' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlSuperMarkets = "SELECT * FROM real_estate_buyer WHERE property_type = 'others' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sql = "SELECT * FROM real_estate_buyer ORDER BY id DESC";
        $result = $conn->query($sql);
        $rowsCount = mysqli_num_rows($result);
        if ($result->num_rows > 0) {

        // Total Completed
        $sqlActive = "SELECT * FROM real_estate_buyer WHERE employee_status = 'Active'";
        ...
        // Total In Completed
        $sqlInActive = "SELECT * FROM real_estate_buyer WHERE employee_status = 'In Active'";
                                        ...
                                        <td>
                                            ...
                                            <?php 
                                                ...
                                                if ($dataSchoolsCat == 'house') {
                                                    $schoolCompleted=mysqli_query($conn, "SELECT count(*) as schoolCompleteTotal FROM real_estate_buyer WHERE property_type = 'house' GROUP BY property_type");
                                        ...
                                        <td>
                                            ...
                                            <?php 
                                                    ...
                                                    foreach($dataSchools as $s){
                                                        if ($dataSchoolsCat == 'house' && $s == 'Active') {
                                                            $schoolInCompleted=mysqli_query($conn, "SELECT count(*) as schoolInCompleteTotal FROM real_estate_buyer WHERE property_type = 'house' && employee_status = 'Active' GROUP BY property_type");
                                                    ...
                                                    if($dataSchoolsCat !== 'house' || $s == 'In Active'){
                                        ...
                                        <td>
                                            <p class="count-num">
                                                ...
                                                if ($dataCollegesCat == 'land') {
                                                    $collegeCompleted=mysqli_query($conn, "SELECT count(*) as collegeCompleteTotal FROM real_estate_buyer WHERE property_type = 'land' GROUP BY property_type");
                                            ...
                                            <p class="count-num">
                                                <?php 
                                                    ...
                                                    foreach($dataColleges as $c){
                                                        if ($dataCollegesCat == 'land' && $c == 'Active') {
                                                            $collegeInCompleted=mysqli_query($conn, "SELECT count(*) as collegeInCompleteTotal FROM real_estate_buyer WHERE property_type = 'land' && employee_status = 'Active' GROUP BY property_type");
                                                    ...
                                                    if($dataCollegesCat !== 'land' || $c == 'In Active'){
                                                        $collegeInCompletedData = 0;
                                                        echo $collegeInCompletedData;
                                                    }
                                                ?>
                                        ...
                                        <td>
                                            <p class="count-num">
                                                ...
                                                if ($dataHospitalsCat == 'agriculture') {
                                                    $hospitalCompleted=mysqli_query($conn, "SELECT count(*) as hospitalCompleteTotal FROM real_estate_buyer WHERE property_type = 'agriculture' GROUP BY property_type");
                                            ...
                                            <p class="count-num">
                                                <?php 
                                                    ...
                                                    foreach($dataHospitals as $h){
                                                        if ($dataHospitalsCat == 'agriculture' && $h == 'Active') {
                                                            $hospitalInCompleted=mysqli_query($conn, "SELECT count(*) as hospitalInCompleteTotal FROM real_estate_buyer WHERE property_type = 'agriculture' && employee_status = 'Active' GROUP BY property_type");
                                                    ...
                                                    if($dataHospitalsCat !== 'agriculture' || $h == 'In Active'){
                                        ...
                                        <td>
                                            <p class="count-num">
                                                ...
                                                if ($dataSuperMarketssCat == 'others') {
                                                    $superMarketsCompleted=mysqli_query($conn, "SELECT count(*) as superMarketsCompleteTotal FROM real_estate_buyer WHERE property_type = 'others' GROUP BY property_type");
                                            ...
                                            <p class="count-num">
                                                <?php
                                                    ...
                                                    foreach($dataSuperMarketss as $smm){
                                                        if ($dataSuperMarketssCat == 'others' && $smm == 'Active') {
                                                            $superMarketsInCompleted=mysqli_query($conn, "SELECT count(*) as superMarketsInCompleteTotal FROM real_estate_buyer WHERE property_type = 'others' && employee_status = 'Active' GROUP BY property_type");
                                                        ...
                                                        // else if ($dataSuperMarketssCat == 'others' && $smm == 'In Active') {
                                                        //     $superMarketsInCompletedData = 0;
                                                        //     echo $superMarketsInCompletedData;
                                                        // }
                                                    } 
                                                    if($dataSuperMarketssCat !== 'others' || $smm == 'In Active'){
                                                        $superMarketsInCompletedData = 0;
                                                        echo $superMarketsInCompletedData;
                                                    }
                                                ?>
        ...
        <div class="row block">
            <div class="col-lg-12 table-responsive shadow-sm bg-white rounded" id="table_container">
                <table class="table table-bordered" id="table_main">
                        <thead>
                            <tr class="table-info table-th-red">
                            <th>Id</th>
                            <th>Name</th>
                            <th>Property Type</th>
...
// edit 
function edit(id){
    window.open('./rb-profile-edit.php?id='+id, '_self');
}
function del(delId){
