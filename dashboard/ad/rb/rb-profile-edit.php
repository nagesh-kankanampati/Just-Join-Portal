...
<body>
  ...
  <?php
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
          <label for="propertyBuyerSurname">Last Name<span class="mandatory">*</span></label>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          <label for="propertValue">Property Value<span class="mandatory">*</span></label>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          <label for="buyerAddress">Address<span class="mandatory">*</span></label>
          <textarea type="text" class="form-control" id="buyerAddress" placeholder="Buyer Address"><?php echo $row['buyer_address']?></textarea>
        </div>        
      </div>
      <div class="form-row">        
        <div class="form-group col-md-6">
