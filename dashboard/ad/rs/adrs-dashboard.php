...
<body>
                    ...
                    <ul>
                      ...
                      <li class="drop-down scrolltoDrop"><a href="#">Realestate</a> 
                        <ul>
                            ...
                            <li><a href="./adrs-dashboard.php" class="employer">Seller</a></li>
                          </ul>
                      </li>
    ...
    <?php       
        ...
        $sqlSchool = "SELECT * FROM real_estate_seller  WHERE property_type = 'house' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlCollege = "SELECT * FROM real_estate_seller  WHERE property_type = 'land' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlHospital = "SELECT * FROM real_estate_seller WHERE property_type = 'agriculture' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        $sqlSuperMarkets = "SELECT * FROM real_estate_seller WHERE property_type = 'others' && (employee_status='Active' || employee_status='In Active') ORDER BY id DESC";
        ...
        // Total Completed
        $sqlActive = "SELECT * FROM real_estate_seller WHERE employee_status = 'Active'";
        ...
        // Total In Completed
        $sqlInActive = "SELECT * FROM real_estate_seller WHERE employee_status = 'In Active'";
                                            ...
                                            <?php 
                                                    ...
                                                    foreach($dataSchools as $s){
                                                        if ($dataSchoolsCat == 'house' && $s == 'Active') {
                                                            $schoolInCompleted=mysqli_query($conn, "SELECT count(*) as schoolInCompleteTotal FROM real_estate_seller WHERE property_type = 'house' && employee_status = 'Active' GROUP BY property_type");
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($dataColleges as $c){
                                                        if ($dataCollegesCat == 'land' && $c == 'Active') {
                                                            $collegeInCompleted=mysqli_query($conn, "SELECT count(*) as collegeInCompleteTotal FROM real_estate_seller WHERE property_type = 'land' && employee_status = 'Active' GROUP BY property_type");
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($dataHospitals as $h){
                                                        if ($dataHospitalsCat == 'agriculture' && $h == 'Active') {
                                                            $hospitalInCompleted=mysqli_query($conn, "SELECT count(*) as hospitalInCompleteTotal FROM real_estate_seller WHERE property_type = 'agriculture' && employee_status = 'Active' GROUP BY property_type");
                                                ...
                                                <?php
                                                    ...
                                                    foreach($dataSuperMarketss as $smm){
                                                        if ($dataSuperMarketssCat == 'others' && $smm == 'Active') {
                                                            $superMarketsInCompleted=mysqli_query($conn, "SELECT count(*) as superMarketsInCompleteTotal FROM real_estate_seller WHERE property_type = 'others' && employee_status = 'Active' GROUP BY property_type");
