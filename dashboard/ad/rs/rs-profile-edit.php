...
<body>
  ...
  <div class="form-group col-md-6">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <label for="propertyType">Property Type<span class="mandatory">*</span></label>
        ...
        <div class="form-group col-md-6">
          <label for="propertyLength">Property Length<span class="mandatory">*</span></label>
          <input type="number" class="form-control" name="propertyLength" id="propertyLength"
            placeholder="Ex: 250" value="<?php echo $row['property_length']?>">
        </div> 
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
          <label for="propertyUnit">Property Unit<span class="mandatory">*</span></label>
          <select name="propertyUnit" id="propertyUnit" class="form-control">
            <option value="null" selected>Select</option>
            <option <?php echo $row['property_unit'] == 'sq ft' ? 'selected' : '';?> >Sq ft</option>
            <option <?php echo $row['property_unit'] == 'sq yd' ? 'selected' : '';?> >Sq yd</option>
            <option <?php echo $row['property_unit'] == 'acre' ? 'selected' : '';?> >Acre</option>           
            <option <?php echo $row['property_unit'] == 'others' ? 'selected' : '';?> >Others</option>
          </select>
          <input class="form-control others dropdown_unit mt-4" type="text" name="propertyUnitOthers" id="propertyUnitOthers" placeholder="Other Property Unit" value="<?php echo $row['property_unit_others']?>">
        </div>
      <div class="form-group col-md-6">
          <label for="propertyValue">Property Value<span class="mandatory">*</span></label>
      ...
      <div class="form-row">    
        <div class="form-group col-md-6">
          <label for="image">Property Images<span class="mandatory">*</span></label>
        ...
        <div class="form-group col-md-6">
          <label for="propertyAddress">Propert Address<span class="mandatory">*</span></label>
      ...
      <div class="form-row">    
        <div class="form-group col-md-6">
          <label for="documentsClear">Document Clearence<span class="mandatory">*</span></label>
        ...
        <div class="form-group col-md-6">
          ...
          <input type="Date" class="form-control" name="dateOfSubmit" id="dateOfSubmit" placeholder="DD/MM/YYYY" value="<?php echo $row['submit_date']?>">
        </div>
      ...
      <div class="form-group col-md-4">
        <label for="employeeStatus">Employee Joining Status</label>
          <select name="employeeStatus" id="employeeStatus" class="form-control <?php echo $row['employee_status'] == 'Active' ? 'green' : 'gray';?>">
            <option value="In Active" <?php echo $row['employee_status'] == 'In Active' ? 'selected' : '';?>>In Active</option>
            <option value="Active" <?php echo $row['employee_status'] == 'Active' ? 'selected' : '';?>>Active</option>
          </select>
        </div>
        <div class="form-group col-md-4">
