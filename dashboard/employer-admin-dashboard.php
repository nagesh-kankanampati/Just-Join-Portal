    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            $employee = array(
                ...
                "emp_job_type" => $row['emp_job_type'],
                "no_positions" => $row['no_positions'],
                "gender" => $row['gender'],
...
<head>
    ...
    <title>JJ Employer - Admin Dashboard</title>
...
<body>
    ...
    <div class="container-fluid pt-100">
        <table id="employer" class="display" width="100%"></table>
    </div>
    ...
    <script src="../assets/js/employer-data.js"></script>
</body>
