...
<!-- requirement details end -->
    <?php 
        ...
        if ($result->num_rows > 0) {
            // Total Completed
            $sqlActive = "SELECT * FROM car_buyer WHERE employee_status = 'Complete'";
            ...
            // Total In Completed
            $sqlInActive = "SELECT * FROM car_buyer WHERE employee_status = 'Progress'";
                        ...
                        <?php
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<tr class="each-row'.$new.'" data-id="'.$row["id"].'">
                                        ...
                                        <a href="javascript:void(0)" class="pr-3" onclick="return view('.$row["id"].');"><span class="glyphicon glyphicon-eye-open blue-color"></span></a>
                                        '.$delete.'</td>
