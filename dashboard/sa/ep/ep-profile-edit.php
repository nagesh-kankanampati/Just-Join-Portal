  ...
  <form id='employee-form' class="employee-form">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <input class="form-control" type="text" id="employeeJobExperience" placeholder="Ex: 2yrs" value="<?php echo $row['job_exp']?>">
      </div>   
    </div>
    ...
    <div class="form-row">     
      ...
      <div class="form-group col-md-4">
        ...
        <input class="form-control" type="text" id="employeePresentSalary" placeholder="Ex: 20,000" value="<?php echo $row['present_salary']?>">
      </div> 

      <div class="form-group col-md-4">
        <label for="employeeExpectedSalary">Expected Salary (per month)</label>
        <input class="form-control" type="text" id="employeeExpectedSalary" placeholder="Ex: 50,000" value="<?php echo $row['expected_salary']?>">
      </div> 
      <div class="form-group col-md-4">
    ...
    <a href="./saep-dashboard.php" class="btn btn-danger btn-lg">Cancel</a>
  </form>
