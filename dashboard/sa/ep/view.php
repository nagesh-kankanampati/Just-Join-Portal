                ...
                <div class="col-md-12">
                    ...
                    <div>
                        <table class="table">
                            ...
                            <tbody>
                            <tr>
                                    <td class="col-md-9">Job Name</td>
                                    <td class="col-md-3"><?php echo $row['job_name']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Name</td>
                                    <td class="col-md-3"><?php echo $row['first_name']?> <?php echo $row['last_name']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Father Name</td>
                                    <td class="col-md-3"><?php echo $row['father_name']?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-3"><?php echo $row['dob']?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="col-md-9">Aadhar No.</td>
                                    <td class="col-md-3"><?php echo $row['aadhar'] ? $row['aadhar'] : "-"; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="col-md-9">Organization</td>
                                    <td class="col-md-3"><?php echo $row['organization']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Job Type</td>
                                    <td class="col-md-3"><?php echo $row['job_type']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Job Experience</td>
                                    <td class="col-md-3"><?php echo $row['job_exp']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Present/Previous Company</td>
                                    <td class="col-md-3"><?php echo $row['present_or_previous_company']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Present Salary</td>
                                    <td class="col-md-3"><?php echo $row['present_salary']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Expected Salary</td>
                                    <td class="col-md-3"><?php echo $row['expected_salary']?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <hr />
                    <div class="footer">
                            <p><b>Registered Date: </b><span><?php echo $row['date_of_registered']?></span></p>
                            <p><b>Signature: </b></p>
                    </div>
                </div>
            </div>
