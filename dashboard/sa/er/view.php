                    ...
                    <div>
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="col-md-9">Designation</td>
                                    <td class="col-md-3"><?php echo $row['designation']?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="col-md-9">Organization Type</td>
                                    <td class="col-md-3"><?php echo $row['organization_type']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Organization Name</td>
                                    <td class="col-md-3"><?php echo $row['organization_name']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Employee Category</td>
                                    <td class="col-md-3"><?php echo $row['emp_category']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Employee Job Type</td>
                                    <td class="col-md-3"><?php echo $row['emp_job_type']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Number of Positions</td>
                                    <td class="col-md-3"><?php echo $row['no_positions']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Experience</td>
                                    <td class="col-md-3"><?php echo $row['experience']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Minimum Salary</td>
                                    <td class="col-md-3"><?php echo $row['salary_min']?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-9">Maximum Salary</td>
                                    <td class="col-md-3"><?php echo $row['salary_max']?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
