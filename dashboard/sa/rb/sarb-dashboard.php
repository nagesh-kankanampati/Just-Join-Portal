...
<body>
    ...
    <?php       
        ...
        $sqlSchool = "SELECT * FROM real_estate_buyer  WHERE property_type = 'house' && (employee_status='Complete' || employee_status='Progress') ORDER BY id DESC";
        ...
        $sqlCollege = "SELECT * FROM real_estate_buyer  WHERE property_type = 'land' && (employee_status='Complete' || employee_status='Progress') ORDER BY id DESC";
        ...
        $sqlHospital = "SELECT * FROM real_estate_buyer WHERE property_type = 'agriculture' && (employee_status='Complete' || employee_status='Progress') ORDER BY id DESC";
        ...
        $sqlSuperMarkets = "SELECT * FROM real_estate_buyer WHERE property_type = 'others' && (employee_status='Complete' || employee_status='Progress') ORDER BY id DESC";
        ...
        // Total Completed
        $sqlActive = "SELECT * FROM real_estate_buyer WHERE employee_status = 'Complete'";
        ...
        // Total In Completed
        $sqlInActive = "SELECT * FROM real_estate_buyer WHERE employee_status = 'Progress'";
                                            ...
                                            <?php 
                                                    ...
                                                    foreach($dataSchools as $s){
                                                        if ($dataSchoolsCat == 'house' && $s == 'Complete') {
                                                            $schoolInCompleted=mysqli_query($conn, "SELECT count(*) as schoolInCompleteTotal FROM real_estate_buyer WHERE property_type = 'house' && employee_status = 'Complete' GROUP BY property_type");
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($dataColleges as $c){
                                                        if ($dataCollegesCat == 'land' && $c == 'Complete') {
                                                            $collegeInCompleted=mysqli_query($conn, "SELECT count(*) as collegeInCompleteTotal FROM real_estate_buyer WHERE property_type = 'land' && employee_status = 'Complete' GROUP BY property_type");
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($dataHospitals as $h){
                                                        if ($dataHospitalsCat == 'agriculture' && $h == 'Complete') {
                                                            $hospitalInCompleted=mysqli_query($conn, "SELECT count(*) as hospitalInCompleteTotal FROM real_estate_buyer WHERE property_type = 'agriculture' && employee_status = 'Complete' GROUP BY property_type");
                                                ...
                                                <?php
                                                    ...
                                                    foreach($dataSuperMarketss as $smm){
                                                        if ($dataSuperMarketssCat == 'others' && $smm == 'Complete') {
                                                            $superMarketsInCompleted=mysqli_query($conn, "SELECT count(*) as superMarketsInCompleteTotal FROM real_estate_buyer WHERE property_type = 'others' && employee_status = 'Complete' GROUP BY property_type");
