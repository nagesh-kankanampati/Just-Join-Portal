                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-3"><?php echo $row['fname']?> <?php echo $row['sname']?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="col-md-9">Buyer Address</td>
                                    <td class="col-md-3"><?php echo $row['buyer_address']?></td>
                                </tr>
