  ...
  <div class="container mt160">
   <div class="text-right mt-5">
    ...
    <div class="panel employer-panel-primary">
      <div class="panel-heading">Need Employee? Please fill the below application</div>
    </div>
    ...
    <div class="panel panel-danger">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="employerName" placeholder="Name" value="">
        </div>
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="employerDesignation"
            placeholder="Chairman, Director, Incharge..." value="">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="organisationName"
            placeholder="EX: School, College, Hospital..." value="">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
          <label for="employerPhoneNumber">Phone Number<span class="mandatory">*</span></label>
          <input type="number" class="form-control" id="employerPhoneNumber" placeholder="Phone Number" pattern="pattern="[1-9]{1}[0-9]{9}" maxlength="10">
        </div>
        <div class="form-group col-md-6">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="number" class="form-control" id="employerAadhar" placeholder="Aadhare Number (optional)" value="">
      </div>
        <div class="form-group col-md-6">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-3">
          <label for="employeePositions">Number of employees</label>
          <input class="form-control" type="number" id="employeePositions" placeholder="Ex: 1, 2, 5, 8" value="">
        </div>
      </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          ...
          <!-- <select id="employeeExperience" class="form-control">
          ...
          <input class="form-control" type="text" id="employeeExperience" placeholder="Ex: 2yrs" value="">
        </div>
        <div class="form-group col-md-2">
          <label for="employeeSalaryMin">Salary Min</label>
          <input class="form-control" type="text" id="employeeSalaryMin" placeholder="Ex: 10,000">
        </div>
        <div class="form-group col-md-2">
