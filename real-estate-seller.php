...
<body>
  ...
  <div class="text-right mt-5">
    ...
    <div class="panel employer-panel-primary">
      <div class="panel-heading"> Want to  sale your property (Ex: House, Land, Agriculture Land ...)? Please fill the below application</div>
    </div>
  ...
  <div class="form-group col-md-6">
          ...
          <input type="number" class="form-control" name="phoneNumber" id="phoneNumber" placeholder="Phone Number" pattern="pattern="[1-9]{1}[0-9]{9}" maxlength="10">
        </div>
        
        <div class="form-group col-md-6">
          <label for="aadhar">Aadhar (Optional)</label>
          <input type="number" class="form-control" name="aadhar" id="aadhar" placeholder="Aadhar Number"
           >
        </div>
        <div class="form-group col-md-6">
      ...
      <div class="form-group col-md-12">
        <div class="panel panel-danger">
            <div class="panel-heading">Please fill your property details below</div>      
        </div>
      </div>
    </div>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <select name="propertyType" id="propertyType" class="form-control">
            ...
            <option value="others_type">Others</option>
          </select>
          <input class="form-control others_type dropdown_type mt-4" type="text" name="propertyTypeOthers" id="propertyTypeOthers" placeholder="Other Property Type" value="">
        </div>
        <div class="form-group col-md-6">
          ...
          <textarea type="text" class="form-control" name="propertyDetails" id="propertyDetails"
            placeholder="Ex: Plot 2250 sft, East Face, 0 feet road"></textarea>
        </div> 
      </div>
      <div class="form-row">
        <!-- <div class="form-group col-md-6">
          <label for="propertyUnit">Property Unit</label>
          <select name="propertyUnit" id="propertyUnit" class="form-control">
            <option value="null" selected>Select</option>
            <option value="sqft">Sq ft</option>
            <option value="sqyd">Sq yd</option>
            <option value="acre">Acre</option>           
            <option value="others_unit">Others</option>
          </select>
          <input class="form-control others_unit dropdown_unit mt-4" type="text" name="propertyUnitOthers" id="propertyUnitOthers" placeholder="Other Property Unit" value="">
        </div> -->
      <div class="form-group col-md-6">
      ...
      <div class="form-row">    
        <div class="form-group col-md-6">
          ...
          <!-- <input type="file" class="form-control" name="image" placeholder="Property Images" multiple> -->
      ...
      <div class="form-row">    
        ...
        <!-- <div class="form-group col-md-6">
          <label for="dateOfSubmit">Date of Submit</label>
          <input type="Date" class="form-control" name="dateOfSubmit" id="dateOfSubmit" placeholder="DD/MM/YYYY">
        </div> -->
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
  ...
  <script src="./assets/js/real-estate-seller.js"></script>
